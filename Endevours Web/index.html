...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="./animation/particles.css">
  <link rel="stylesheet" href="./assets/css/animation-button.css">
...
<body>
  ...
  <header id="header">
    ...
    <div class="container">
      ...
      <h1 id="web-title"><a href="index1.html">Endeavours</a></h1>
          <!-- Uncomment below if you prefer to use an image logo -->
          <!-- <a href="index.html" class="mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a> -->
      <h2>Unlock Your <span>Professional Potential</span>: Elevate Your <span>CV Online </h2>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link" href="#resume">Pricing</a></li>
          <li><a class="nav-link" href="#portfolio">Pioneers</a></li>
      ...
      <div class="social-links">
        ...
        <div class="toggle-button-cover">
          ...
          <script src="./assets/js/disableStarsAnimation.js"></script>
      </div>
      ...
      <!-- partial:index.partial.html -->
        <div class="sphere-animation">
          <svg class="sphere" viewBox="0 0 440 440" stroke="rgba(39,39,39,0.35)">
            <defs>
              <linearGradient id="sphereGradient" x1="5%" x2="5%" y1="0%" y2="15%">
                <stop stop-color="#262626" offset="0%"/>
                <stop stop-color="#1c1c1b" offset="50%"/>
  ...
  <div class="credits">
    ...
    Copyrights &copy; 2023 <a href="legals.html">Endeavours</a> - All rights reserved.
  </div>
  ...
  <script src="./animation/particles.min.js"></script>
  <script src="./animation/customParticles.js"></script>
</body>
